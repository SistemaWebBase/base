<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE UNIDADE DE MEDIDA');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from unidades_medida order by unidade limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from unidades_medida where unidade like '" . $pesquisa . "%' order by unidade limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from unidades_medida";
										} else {
											$sql = "select count(*) as num from unidades_medida where unidade like '" . $pesquisa . "%';";
										}
