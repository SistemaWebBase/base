<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE SUBGRUPOS');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from subgrupos order by subgrupo limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from subgrupos where subgrupo like '" . $pesquisa . "%' order by subgrupo limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from subgrupos";
										} else {
											$sql = "select count(*) as num from subgrupos where subgrupo like '" . $pesquisa . "%';";
										}
