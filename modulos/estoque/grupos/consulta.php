							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from grupos order by grupo limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from grupos where grupo like '" . $pesquisa . "%' order by grupo limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from grupos";
										} else {
											$sql = "select count(*) as num from grupos where grupo like '" . $pesquisa . "%';";
										}
