<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE MARCAS');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from marcas order by marca limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from marcas where marca like '" . $pesquisa . "%' order by marca limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from marcas";
										} else {
											$sql = "select count(*) as num from marcas where marca like '" . $pesquisa . "%';";
										}
