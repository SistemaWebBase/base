<?php
   ...
   switch($_POST['_action']) {
         case "inclusao": $nperm = "INCLUIR CADASTRO DE LINHAS";break;
         case "alteracao": $nperm = "ALTERAR CADASTRO DE LINHAS";break;
         case "exclusao": $nperm = "EXCLUIR CADASTRO DE LINHAS";break;
   }
   ...
   if ($_action == "inclusao") {
         $sql = "insert into linhas (linha) values ('" . $linha . "');";
         $msg1 = "incluir";
         $msg2 = "inclusão";
   }
   
   if ($_action == "alteracao") {
         $sql = "update linhas set linha='" . $linha . "' where id=" . $id;
         $msg1 = "alterar";
         $msg2 = "alterado";
   }
   
   if ($_action == "exclusao") {
         $sql = "delete from linhas where id=" . $id;
         $msg1 = "excluir";
         $msg2 = "excluído";
   }
