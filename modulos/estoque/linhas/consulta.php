<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE LINHAS');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from linhas order by linha limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from linhas where linha like '" . $pesquisa . "%' order by linha limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from linhas";
										} else {
											$sql = "select count(*) as num from linhas where nome like '" . $pesquisa . "%';";
										}
