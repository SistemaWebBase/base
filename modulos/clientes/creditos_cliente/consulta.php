<?php
        // validar sessao
        require_once BASE_DIR . '/modulos/../util/sessao.php';

        validarSessao();
		
		// testar permissao
		require_once BASE_DIR . '/modulos/../util/permissao.php';
		$perm = testarPermissao('INCLUIR SOLICITACAO DE CREDITO');
		
		// Testar assinatura da URL
		require_once BASE_DIR . '/modulos/../util/util.php';
		testarAssinaturaURL();
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<tbody>
									<?php
										require_once BASE_DIR . '/modulos/../util/conexao.php';
										require_once BASE_DIR . '/modulos/../util/util.php';
