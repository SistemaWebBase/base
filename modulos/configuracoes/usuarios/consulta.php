<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE USUARIOS');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from usuarios order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from usuarios where nome like '" . $pesquisa . "%' order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										if (empty($pesquisa)) {
											...
											$sql = "select count(*) as num from usuarios where nome like '" . $pesquisa . "%';";
										}
