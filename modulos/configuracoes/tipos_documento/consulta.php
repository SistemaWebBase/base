<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE TIPOS DE DOCUMENTO');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from tipos_documento order by descricao limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from tipos_documento where descricao like '" . $pesquisa . "%' order by descricao limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from tipos_documento";
										} else {
											$sql = "select count(*) as num from tipos_documento where descricao like '" . $pesquisa . "%';";
										}
