				...
				<div class="row">
					...
					<div id="conteudo" class="col-xs-12 col-md-9">
							...
							<div class="panel-body">
								<form role="form">
									<div class="form-group col-md-6">
									    ...
									    <input type="text" inputmode="numeric" pattern="[0-9]*" class="form-control" id="usuario" name="usuario" autocomplete="off" min="0" max="999999" value="<?= $usuario ?>" autofocus>
									</div>
									<div class="form-group col-md-6">
										<label for="permissao">Permissão: <span class="label label-danger">Obrigatório</span></label>
									    <input type="text" inputmode="numeric" pattern="[0-9]*" class="form-control" id="permissao" name="permissao" autocomplete="off" min="0" max="999999" value="<?= $permissao ?>">
									</div>
									<div class="form-group col-md-6">
										<label for="valor">Valor: <span class="label label-danger">Obrigatório</span></label>
										<input type="text" class="form-control" id="valor" name="valor" autocomplete="off" maxlength="60" value="<?= $valor ?>" >
									</div>
						...
						<div class="btn-control-bar">
							<div class="panel-heading">
								<button class="btn btn-success mob-btn-block" onclick="submit('#usuario');">
								...
								<button class="btn btn-danger mob-btn-block" style="<?php if ($_action == "inclusao") { echo "display: none"; } ?>" data-toggle="modal" data-target="#modal" onclick="dialogYesNo('esubmit()', null, 'Excluir Permissão do Usuário', 'Deseja excluir esta Permissão ?', 'trash');">
