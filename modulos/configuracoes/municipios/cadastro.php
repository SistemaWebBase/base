							...
							<div class="panel-body">
								<form role="form">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="municipio" name="municipio" autocomplete="off" maxlength="60" value="<?= $municipio ?>" autofocus required <?php permissao(); ?>>
									</div>
									<div class="form-group col-md-3">
										<label for="uf">UF: <span class="label label-danger">Obrigatório</span></label>
										<select class="form-control" id="uf" name="uf" required <?php permissao(); ?>>
										<?php
									...
									<div class="form-group col-md-3">
										...
										<input type="number" inputmode="numeric" pattern="[0-9]{5}" class="form-control" id="ibge" name="ibge" autocomplete="off" min="0" max="999999"  value="<?= $ibge ?>" required <?php permissao(); ?>>
									</div>
