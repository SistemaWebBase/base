<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE VENDEDORES');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from vendedores order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from vendedores where nome like '" . $pesquisa . "%' order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from vendedores";
										} else {
											$sql = "select count(*) as num from vendedores where nome like '" . $pesquisa . "%';";
										}
