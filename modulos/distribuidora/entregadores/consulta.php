<?php
		...
		$perm = testarPermissao('INCLUIR CADASTRO DE ENTREGADORES');
							...
							<div class="panel-body">
								...
								<table class="table table-hover table-striped tabela-registro" id="tabela">
									...
									<?php
										...
										if (empty($pesquisa)) {
											$sql = "select * from entregadores order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										} else {
											$sql = "select * from entregadores where nome like '" . $pesquisa . "%' order by nome limit " . $limite . " offset " . (($pagina-1)*$limite);
										}
										...
										// Paginaçao
										if (empty($pesquisa)) {
											$sql = "select count(*) as num from entregadores";
										} else {
											$sql = "select count(*) as num from entregadores where nome like '" . $pesquisa . "%';";
										}
